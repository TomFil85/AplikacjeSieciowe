...
require_once $conf->root_path.'/app/calc_kred/CalcForm.class.php';
require_once $conf->root_path.'/app/calc_kred/CalcResult.class.php';
...
class CalcCtrl {
	...
	public function generateView(){
		...
		$smarty->display($conf->root_path.'/app/calc_kred/calc_kred.tpl');
	}
}
